...
public class Test{
    ...
    private static void TestCase(Scanner myScanner){
        ...
        Investment investment1 = new Investment(false, 12, 1.5f, 10000, 0, "months", "month");
        Investment investment2 = new Investment(false, 1, 18f, 10000, 0, "years", "year");
        Investment investment3 = new Investment(true, 12, 1.5f, 10000, 0.15f, "months", "month");
        Investment investment4 = new Investment(true, 1, 18f, 10000, 0.15f, "years", "year");
